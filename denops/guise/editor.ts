...
import * as anonymous from "https://deno.land/x/denops_std@v2.2.0/anonymous/mod.ts";
import * as batch from "https://deno.land/x/denops_std@v2.2.0/batch/mod.ts";
import * as fn from "https://deno.land/x/denops_std@v2.2.0/function/mod.ts";
import * as option from "https://deno.land/x/denops_std@v2.2.0/option/mod.ts";
import { deferred } from "https://deno.land/std@0.114.0/async/mod.ts";
